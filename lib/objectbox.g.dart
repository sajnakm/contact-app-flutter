...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 1739425210470214257),
      name: 'ContactEntity',
      lastPropertyId: const obx_int.IdUid(3, 727178386397310565),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 4750482431928360090),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 2701056966885632369),
            name: 'name',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 727178386397310565),
            name: 'phonenumber',
            type: 9,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 1739425210470214257),
    ...
    ContactEntity: obx_int.EntityDefinition<ContactEntity>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = ContactEntity(
              id: idParam, name: nameParam, phonenumber: phonenumberParam);
